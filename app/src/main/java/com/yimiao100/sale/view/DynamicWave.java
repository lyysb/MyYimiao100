...
public class DynamicWave extends View {
    ...
    // 波纹颜色
    private static int WAVE_PAINT_COLOR = 0x884188d2;
    // y = Asin(wx+b)+h
    ...
    public DynamicWave(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mXOffsetSpeedOne = DensityUtil.dp2px(context, TRANSLATE_X_SPEED_ONE);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mTotalWidth; i++) {
            ...
            // 绘制第一条水波纹
            canvas.drawLine(i, mTotalHeight - mResetOneYPositions[i] - mWaveHight, i,
                    mTotalHeight,
                    mWavePaint);

            // 绘制第二条水波纹
            canvas.drawLine(i, mTotalHeight - mResetTwoYPositions[i] - mWaveHight, i,
                    mTotalHeight,
                    mWavePaint);
        }
