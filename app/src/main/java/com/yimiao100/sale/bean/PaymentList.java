...
public class PaymentList {
    ...
    private ArrayList<Payment> paymentStatList;
    private ArrayList<Payment> paymentTotalStatList;
    ...
    public ArrayList<Payment> getPaymentStatList() {
        return paymentStatList;
    }

    public void setPaymentStatList(ArrayList<Payment> paymentStatList) {
        this.paymentStatList = paymentStatList;
    }

    public ArrayList<Payment> getPaymentTotalStatList() {
        return paymentTotalStatList;
    }

    public void setPaymentTotalStatList(ArrayList<Payment> paymentTotalStatList) {
        this.paymentTotalStatList = paymentTotalStatList;
    }
}
