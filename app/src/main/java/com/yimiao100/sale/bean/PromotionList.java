...
public class PromotionList {
    ...
    private double totalDepositWithdraw;
    ...
    public double getTotalDepositWithdraw() {
        return totalDepositWithdraw;
    }

    public void setTotalDepositWithdraw(double totalDepositWithdraw) {
        this.totalDepositWithdraw = totalDepositWithdraw;
    }
