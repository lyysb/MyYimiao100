...
public class ShipList {
    ...
    private ArrayList<Delivery> deliveryStatList;
    private ArrayList<Delivery> deliveryTotalStatList;
    ...
    public ArrayList<Delivery> getDeliveryStatList() {
        return deliveryStatList;
    }

    public void setDeliveryStatList(ArrayList<Delivery> deliveryStatList) {
        this.deliveryStatList = deliveryStatList;
    }

    public ArrayList<Delivery> getDeliveryTotalStatList() {
        return deliveryTotalStatList;
    }

    public void setDeliveryTotalStatList(ArrayList<Delivery> deliveryTotalStatList) {
        this.deliveryTotalStatList = deliveryTotalStatList;
    }
}
